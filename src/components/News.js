        ...
        <Container>
          ...
          <Row>
            <Col xs={12} sm={8} className="main-section">
              <p>Greentech Inc is developed by a group of software engineering students just for publishing free software and applications.</p>
